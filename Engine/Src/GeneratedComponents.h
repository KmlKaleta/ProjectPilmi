...
#define AdditionalComponentNamesMacro(X) \
    ...
    X(PHYSICS_BOX, PhysicsBoxComponent) \
    X(PHYSICS_BODY, PhysicsBodyComponent)
...
#define TagComponentNamesMacro(X) \
    ...
    X(PLAYER_CONTROLLABLE, PlayerControllableTag)
...
VISITABLE_STRUCT(AnimatorComponent, Data, Animation, FrameTime);

void to_json(JSON& j, const MainMenuComponent& component);
void from_json(const JSON& j, MainMenuComponent& component);
VISITABLE_STRUCT(MainMenuComponent, TitleScale, SheepText, GoesText, DevileText);

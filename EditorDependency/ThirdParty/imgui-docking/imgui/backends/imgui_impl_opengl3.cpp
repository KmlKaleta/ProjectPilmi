...
//  2025-07-15: OpenGL: Set GL_UNPACK_ALIGNMENT to 1 before updating textures.png (#8802) + restore non-WebGL/ES update path that doesn't require a CPU-side copy.
...
void ImGui_ImplOpenGL3_UpdateTexture(ImTextureData* tex)
{
    ...
    {
        // Update selected blocks. We only ever write to textures.png regions which have never been used before!

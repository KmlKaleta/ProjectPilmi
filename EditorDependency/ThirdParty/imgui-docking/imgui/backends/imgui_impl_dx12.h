...
struct ImGui_ImplDX12_InitInfo
{
    ...
    // Allocating SRV descriptors for textures.png is up to the application, so we provide callbacks.
...
// (Advanced) Use e.g. if you need to precisely control the timing of texture updates (e.g. for staged rendering), by setting ImDrawData::Textures.png = nullptr to handle this manually.

...
static void DemoWindowWidgetsImages()
{
    if (ImGui::TreeNode("Images"))
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            // UV coordinates are often (0.0f, 0.0f) and (1.0f, 1.0f) to display an entire textures.png.
...
{
    ImFontAtlas* atlas = ImGui::GetIO().Fonts;
    ImTextureRef tex_ref = atlas->TexRef; // We don't have access to other textures.png in this demo!

...
struct ImGuiContext
{
    ...
    ImVector<ImTextureData*> UserTextures;                      // List of textures.png created/managed by user or third-party extension. Automatically appended into platform_io.Textures.png[].
